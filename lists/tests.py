...
class ListViewTest(TestCase):
    ...
    def test_displays_only_items_for_that_list(self):
        ...
        Item.objects.create(text='Correct list item one', list=correct_list)
        Item.objects.create(text='Correct list item two', list=correct_list)
        ...
        self.assertContains(response, 'Correct list item one')
        self.assertContains(response, 'Correct list item two')
...
class CreateNewListItemViewTest(TestCase):
    ...
    def test_can_save_a_POST_request_to_an_existing_list(self):
        ...
        self.client.post(
            f'/lists/{correct_list.id}/add-todo',
